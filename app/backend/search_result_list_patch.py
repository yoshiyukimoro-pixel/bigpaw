...
print('PUBLIC_SEARCH_LIST_OK|layout=photo_left_info_right|mobile=single_column|image=square|lazy=enabled|offscreen=content_visibility|birth_color_gender_price=shown',flush=True)
