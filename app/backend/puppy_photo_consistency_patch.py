...
print('PUPPY_PHOTO_CONSISTENCY_OK|square_frame=fixed|initial=contain|breeder_pinch_pan=enabled|adjusted_square_saved=enabled|auto_cover_crop=disabled',flush=True)
