...
if p.exists():
 ...
 marker='</head>'
 css='''<style id="bigpaw-search-overlay-safety">\n/* Search results must never start behind a stale picker/modal overlay. */\nbody:not(.breed-picker-open) .breed-picker-overlay,body:not(.breed-picker-open) .breed-picker-modal,body:not(.breed-picker-open) [data-breed-picker-overlay]{display:none!important;pointer-events:none!important;opacity:0!important}\n</style>\n'''
